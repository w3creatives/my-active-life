    ...
    <div class="card">
        <div class="row card-header flex-column flex-md-row border-bottom mx-0 px-3">
            <div class="d-md-flex justify-content-between align-items-center dt-layout-start col-md-auto me-auto mt-0">
                <div class="card-title d-flex justify-content-between">
                    <h5 class="pb-0 text-md-start text-center p-0 m-0">Quest Categories</h5>
                </div>
            </div>
            <div class="d-md-flex justify-content-between align-items-center dt-layout-end col-md-auto ms-auto mt-0">
                <div class="dt-buttons btn-group flex-wrap mb-0">
                    <a href="{{ route('admin.quests.categories.create') }}" class="btn create-new btn-primary" tabindex="0"
        ...
        <div class="card-datatable text-nowrap">
            <table class="datatables-ajax table table-bordered" id="item-list-table"
                   data-ajax-url="{{ route('admin.quests.categories') }}">
                <thead>
                <tr>
                    <th width="50">ID</th>
                    <th>Name</th>
