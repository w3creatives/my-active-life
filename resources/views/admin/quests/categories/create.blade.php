<x-admin-layout title="{{ $item?'Update':'Add'}} Quest Category">
        ...
        <div class="col-md-12">
            <div class="card card-action">
                <div class="card-header">
                    <h5 class="card-action-title mb-0">{{ $item?'Update':'Add'}} Quest Category</h5>
                    <div class="card-action-element">
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item">
                                <a href="{{ route('admin.quests.categories') }}" class="btn btn-label-primary">Back to List</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form action="" class="needs-validation" method="POST" id="event-form" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            <button type="submit" class="btn btn-primary">{{ $item?'Update':'Add'}} Category</button>
