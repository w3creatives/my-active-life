                        ...
                        <div class="info-container">
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-3">
                                    ...
                                    <span class="badge bg-label-{{ $client->is_active?'success':'warning' }}">{{ $client->is_active?'Active':'Inactive' }}</span>
                                </li>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 order-0 order-md-1">
            ...
            <ul class="nav nav-pills mb-3" role="tablist">
                <li class="nav-item" role="presentation">
                    <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-events" aria-controls="navs-pills-events" aria-selected="true">Events</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-users" aria-controls="navs-pills-users" aria-selected="false" tabindex="-1">Users</button>
                </li>
            </ul>
