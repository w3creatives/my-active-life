            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="" class="needs-validation" enctype="multipart/form-data" method="POST" id="event-form" novalidate>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <input type="file" id="logo" name="logo" data-preview=".logo-preview" class="form-control choose-file">
                            ...
                            <div class="col">
                                <div class="mb-4">
                                    ...
                                    <input type="file" id="team_logo" data-preview=".team-logo-preview" name="team_logo" class="form-control choose-file">
                        ...
                        <a href="{{ route('admin.events.milestones', $event->id) }}" class="btn btn-label-primary">Back to Milestones</a>
                        </div>
