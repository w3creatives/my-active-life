                    ...
                    <form action="" class="needs-validation" method="POST" id="event-form" novalidate>
                        ...
                        <div class="row">
                            <div class="mb-4 col-xl-4 col-sm-12 col-md-6">
                                ...
                                <select class="form-select" name="event_type" id="event_type"
                                    ...
                                    @foreach($eventTypes as $eventTypeKey => $eventType)
                                        <option value="{{ $eventTypeKey }}" {{ ($event && $event->event_type == $eventTypeKey)?'selected':''}}>{{ $eventType }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-4 col-xl-4 col-sm-12 col-md-6">
                            ...
                            <div class="mb-4 col-xl-4 col-sm-12 col-md-6">
                                ...
                                <input type="text" name="social_hashtags" id="social_hashtags" value="{{ $event->social_hashtags??'' }}" class="form-control">
                            </div>
                            <div class="mb-4 col-xl-4 col-sm-12 col-md-6">
                                <label for="start_date" class="form-label">Start Date</label>
                                <input type="date" name="start_date" id="start_date"
                                       class="form-control @error('start_date') parsley-error @enderror" value="{{ $event->start_date??'' }}" required
                            ...
                            <div class="mb-4 col-xl-4 col-sm-12 col-md-6">
                                ...
                                <input type="date" name="end_date" id="end_date"
                                       ...
                                       data-parsley-trigger="change" placeholder="YYYY-MM-DD" value="{{ $event->end_date??'' }}">
                            </div>
                            <div class="mb-4 col-xl-4 col-sm-12 col-md-6">
                                <label for="total_points" class="form-label">Total Points</label>
                                <input type="text" id="total_points" name="total_points" class="form-control" value="{{ $event->total_points??'' }}">
                            </div>
                            ...
                            <div class="mb-4 col-xl-4 col-sm-12 col-md-6">
                                ...
                                <select class="form-select select2" name="modalities[]" id="modalities"
                                    ...
                                    @foreach($modalities as $modality)
                                        <option value="{{ $modality->name }}" {{ in_array($modality->name,$selectedModalities)?'selected':''}}>{{ $modality->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-4 col-xl-4 col-sm-12 col-md-6">
                                ...
                                <input type="text" id="registration_url" name="registration_url" class="form-control" value="{{ $event->registration_url??'' }}">
                            </div>

                            <div class="mb-4 col-xl-4 col-sm-12 col-md-6">
                                <label for="goals" class="form-label">Goals</label>
                                <input type="text" id="goals" name="goals" class="form-control" value="{{ $event && $event->goals?implode(',',json_decode($event->goals)):'' }}" placeholder="500,1000,1500,2000">
                            </div>
                        </div>
