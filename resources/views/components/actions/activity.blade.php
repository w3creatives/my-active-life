<div class="d-inline-block">
    <div class="d-inline-block">
        ...
        <div class="dropdown-menu dropdown-menu-end m-0">
            ...
            <a href="{{ route('admin.events.milestones.view', [$item->event_id,$item->id]) }}" class="d-none dropdown-item waves-effect" data-bs-toggle="modal" data-bs-target="#view-milestone-modal"><i class="icon-base ti tabler-target mb-2"></i> View Details</a>
        </div>
    </div>
</div>
