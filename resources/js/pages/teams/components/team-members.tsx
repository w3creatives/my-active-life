...
export default function TeamMembers() {
    ...
    const UserRowSkeleton = () => (
        <div className="flex flex-wrap lg:items-center p-4 border-b text-sm">
            ...
            <div className="w-full lg:w-1/3 lg:text-right mt-2 lg:mt-0">
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Below is a list of your current teammates.
                </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
                ...
                <div className="border rounded-md">
                    <div className="grid grid-cols-3 md:grid-cols-3 px-4 py-2 border-b bg-muted text-muted-foreground text-sm font-medium">
                        <div>Member Name</div>
                        <div>Miles</div>
                    ...
                    {loading ? (
                        ...
                        users.data.map((member) => (
                            ...
                            >
                                ...
                                <div className="w-full lg:w-1/3 lg:text-right mt-2 lg:mt-0">
                                    { member.id === auth.user.id && <Button variant="danger" size="sm" onClick={()=> handleLeaveTeam(member)}>
                                        Leave Team
                                    </Button> }
                                </div>
                            </div>
