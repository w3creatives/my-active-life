    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                ...
                <div className="space-y-6">
                    <p>
                        This area allows you to change your privacy options. If you set your profile to public, other event participants will be able
                        to follow your progress on your fitness journey. By default, all profiles are set to private.
                    </p>
