                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                        <div>
                            ...
                            <p className="text-xl text-muted-foreground">
                                Your achievements in <span
                                className="font-semibold text-foreground">{trophyData.event.name}</span>
                            </p>
                        </div>
                        ...
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <CardDescription>
                                        {trophyStats.earned} of {trophyStats.total} badges earned
                                        ({trophyStats.percentage.toFixed(1)}%)
                                    </CardDescription>
                                </div>
                                        ...
                                        <DialogTrigger asChild>
                                            ...
                                            >
                                                <div className="relative">
                                                    <div
                                                        className="aspect-square rounded-lg overflow-hidden bg-muted/20 border-2 border-transparent group-hover:border-primary/20 transition-colors">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                {milestone.video_url && (
                                                    <Button variant="outline" className="w-full" asChild>
                                                        <a href={milestone.video_url} target="_blank"
