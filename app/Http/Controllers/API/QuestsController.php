    ...
    public function registration(Request $request): JsonResponse
    {
        ...
        if ($request->invitees_email) {
            foreach ($request->invitees_email as $inviteeEmail) {
                ...
                $activity->invitations()->create(['inviter_id' => $user->id, 'invitee_id' => $invitee ? $invitee->id : null, 'invitee_email' => $inviteeEmail, 'accepted' => false, 'secret' => mb_strtoupper(str()->random(32))]);
            }
        }
